...
const RECEIPT_COPY: Record<ReceiptLanguage, ReceiptCopy> = {
  vi: {
    ...
    invoiceRequestQr: "Quét mã để yêu cầu xuất hóa đơn",
    invoiceRequestHint: "Vui lòng điền thông tin xuất hóa đơn trước 22:30 cùng ngày.",
  ...
  en: {
    ...
    invoiceRequestHint: "Please submit your invoice details before 10:30 PM today.",
  ...
  zh: {
    ...
    invoiceRequestHint: "请于当天22:30前填写发票信息。",
