            ...
            <div className="flex flex-col gap-3">
                <div className="flex items-start justify-between gap-2.5">
                    <div className="flex min-w-0 flex-1 items-center gap-3">
                        <div className="flex size-12 shrink-0 select-none items-center justify-center rounded-xl border border-orange-200/60 bg-gradient-to-br from-orange-100 via-amber-50 to-orange-50 font-extrabold tracking-wider text-[var(--color-accent)] shadow-xs">
                            <IoShapes className="size-5" />
                        </div>
