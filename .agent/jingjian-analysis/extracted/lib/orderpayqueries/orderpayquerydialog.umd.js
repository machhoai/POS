(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["orderpayquerydialog"] = factory(require("client-module-engine"), require("client-module-service"), require("vue"));
	else
		root["orderpayquerydialog"] = factory(root["client-module-engine"], root["client-module-service"], root["vue"]);
...
/* harmony default export */ var orderpayqueries_OrderPayCorrectISV = (component.exports);
...
// CONCATENATED MODULE: ./packages/orderpayqueries/index.ts


var orderpayqueries_install = function install(vue) {
  vue.component('AppOrderPayQueryDialog', orderpayqueries_OrderPayQueryDialog);
  console.log('加载支付成功');
};


// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib-no-default.js
/* concated harmony reexport OrderPayQueryDialog */__webpack_require__.d(__webpack_exports__, "OrderPayQueryDialog", function() { return orderpayqueries_OrderPayQueryDialog; });
/* concated harmony reexport install */__webpack_require__.d(__webpack_exports__, "install", function() { return orderpayqueries_install; });
